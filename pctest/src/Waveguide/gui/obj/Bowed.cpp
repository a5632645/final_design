...
void CBowed::SetPageIdx(int8_t page) {
    ...
    if (pageIdx_ != page) {
        ...
        case ePage_page1:
            ...
            knobs_[6].BindParamDesc(params.bow.lossGain);
            knobs_[7].BindParamDesc(params.bow.decay);
            knobs_[8].BindParamDesc(params.bow.lossFaster);
            knobs_[9].BindParamDesc(params.bow.noise);
            knobs_[10].BindParamDesc(params.bow.noiseLP);
            totalKnobs_ = 11;
            break;
        case ePage_page2:
            knobs_[0].BindParamDesc(params.bow.autoVibrate);
            ...
            knobs_[4].BindParamDesc(params.bow.autoTremolo);
            ...
            knobs_[8].BindParamDesc(params.bow.manualPitch);
            knobs_[9].BindParamDesc(params.bow.manualSpeed);
            knobs_[10].BindParamDesc(params.bow.attack);
            knobs_[11].BindParamDesc(params.bow.release);
            totalKnobs_ = 12;
            break;
        case ePage_page3:
